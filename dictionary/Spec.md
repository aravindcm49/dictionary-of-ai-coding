A **handoff artifact** (see [[Handoff artifact]]) describing a multi-session piece of work — what's being built, not how each session does its share. Mutates as work progresses. Made of **tickets** (see [[Ticket]]).
