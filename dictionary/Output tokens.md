Tokens (see [[Token]]) the model (see [[Model]]) generates back. Billed at a higher rate than input tokens (see [[Input tokens]]), since they cost more compute to produce.
